...
import com.ntg.organization.organization.service.DepartementService;
...
public class EmployeeController {
	...
	@PostMapping("customer/addDepartment")
	public Department requestLoan(@RequestBody Department department)
	{
		return departmentService.linkDeptToEmp(department);
}
}
